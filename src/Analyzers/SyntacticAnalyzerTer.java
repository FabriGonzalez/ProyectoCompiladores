...
public class SyntacticAnalyzerTer {
    LexicalAnalyzer aLex;
    Token currentToken;

    public SyntacticAnalyzerTer(LexicalAnalyzer lex) throws LexicalException, IOException, SyntacticException {
        aLex = lex;
    ...
    void r_modificador() throws SyntacticException, LexicalException, IOException {
        switch (currentToken.getId()) {
    ...
    void expresionCondicional() throws LexicalException, SyntacticException, IOException {
        if(currentToken.getId().equals("?")){
            match("?");
            expresionCompuesta();
            match(":");
    ...
    void r_expresionCompuesta() throws LexicalException, SyntacticException, IOException {
        expresionBasica();
        rr_expresionCompuesta();
    }

    void rr_expresionCompuesta() throws LexicalException, SyntacticException, IOException {
